...
module GHC.Integer (
    ...
    --
    -- | These operations return @0#@ and @1#@ instead of 'False' and 'True' respectively.
    -- See <https://ghc.haskell.org/trac/ghc/wiki/PrimBool PrimBool wiki-page> for more details
    eqInteger#, neqInteger#, leInteger#, gtInteger#, ltInteger#, geInteger#,
